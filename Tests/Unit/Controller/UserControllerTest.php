...
{
    /**
     * @var \SmartPAYD\UserPolicy\Controller\UserController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\SmartPAYD\UserPolicy\Controller\UserController::class)
    ...
    {
        $user = new \SmartPAYD\UserPolicy\Domain\Model\User();
